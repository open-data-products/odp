...
def test_unused_tables_detection_with_valid_input():
    ...
    info_schema = {
        ...
        "test_catalog_3": {
            "test_db":
                {
                 "test_table_unused_3": {"column1": "type1"}
                 },
        },
    }
    ...
    info_schema_flat = [
        ...
        ("test_catalog", "test_db_2", "test_table_unused", "column1"),
        ("test_catalog_2", "test_db", "test_table_unused_2", "column1"),
    ]
    ...
    assert unused_tables == [
        ...
        ("TEST_CATALOG_3", "TEST_DB", "TEST_TABLE_UNUSED_3")
    ]


def test_tables_detection_with_multiple_tables_in_query():
    queries = [QueryRow(
